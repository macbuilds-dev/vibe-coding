...
**Max 29 commits per chat/work session** when the user asks to commit/push.  
Prefer many small *real* commits. Never empty/junk commits.

## When user says push / commit

1. Inspect status + diff.
2. Split into logical commits (file or feature sized), ≤ 29 total this session.
3. Prefer a feature branch + PR for Push/merge flow (helps Pull Shark).
